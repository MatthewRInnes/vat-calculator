/**
 * Sidebar component for navigation and content organisation
 * Includes collapsible functionality and mobile responsiveness
 */
  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // Update cookie for state persistence
